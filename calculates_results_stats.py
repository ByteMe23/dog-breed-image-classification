...
#                                                                             
# PROGRAMMER: Devendra Badaik
# DATE CREATED: 03/09/2025                             
# REVISED DATE: 03/09/2025 
...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        if results_dic[key][3] == 1:  # Pet image is a dog
            ...
            if results_dic[key][4] == 1:  # Classifier correctly classified as a dog
                results_stats_dic['n_correct_dogs'] += 1
            if results_dic[key][2] == 1:  # Match between pet image and classifier labels
                results_stats_dic['n_correct_breed'] += 1
        else:  # Pet image is not a dog
            results_stats_dic['n_notdogs_img'] += 1
            if results_dic[key][4] == 0:  # Classifier correctly classified as NOT a dog
